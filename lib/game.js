...
export default class Game {
    ...
    prepareStageTwo() {
        ...
        if (this.stageCount > StageDivides.TWO.beginning && this.stageCount < StageDivides.TWO.ending) {
            ...
            this.evilMinion.position = evilMinionOnePosition;
            this.evilMinion2.position = evilMinionTwoPosition;
            this.evilMinion3.position = evilMinionThreePosition;
            this.evilMinion4.position = evilMinionFourPosition;
    ...
    resetToStageOne() {
        ...
        if (this.stageCount > 1800) {
            ...
            this.stageCount = 0;
            this.stage = 1;
            this.obstacle.position = skyscraperOnePosition;
            this.obstacle2.position = skyscraperTwoPosition;
            this.obstacle.activated = true;
            this.obstacle2.activated = true;

            if (this.flyingObstacle) {
                this.flyingObstacle.position = flyingObstaclePosition;
